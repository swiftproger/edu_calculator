...
class MainStackView: UIStackView {
    ...
    private func setupMainStackView() {
        ...
        let fourStackView = UIStackView(subviews: [button7, button8, button9, buttonMulti])
        ...
        stackViewArray = [fifthStackView, fourStackView, thirdStackView, secondStackView, firstStackView]
    }
}
